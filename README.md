...
项目目标是制作一款以 **Q版明朝抗倭** 为背景的类《吸血鬼幸存者》俯视角肉鸽生存游戏：自动攻击 + 主动走位 + Roguelite Build。玩家扮演不同身份的明军，通过角色、武器、兵法（Build）、状态反应构筑战斗流派，对抗源源不断的倭寇。美术风格为像素化 Q 版，所有人物、怪物、特效、UI 装饰素材都由 PixiJS 代码绘制大像素块实现，不依赖图片素材。
